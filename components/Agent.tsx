...
const Agent = ({ userName, userId, type, interviewId, questions }: AgentProps) => {
    ...
    const lastMessage = messages[messages.length - 1]?.content || "AI is ready to interview you.";
    const isCallIsInactiveOrFinished = callStatus === CallStatus.INACTIVE || callStatus === CallStatus.FINISHED;
